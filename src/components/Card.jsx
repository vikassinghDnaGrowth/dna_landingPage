...
const Card = ({ companyName, service, Solution, Challenge }) => {
  return (
    <div className="rounded-lg shadow-xl bg-white p-4 hover:scale-105 transition-all duration-300 ease-in-out border-2 border-transparent hover:border-indigo-500 flex flex-col justify-center items-center w-full sm:w-5/12 md:w-5/12 lg:w-5/12">
